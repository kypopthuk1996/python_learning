...
#с учетом ключевых слов add, delvvvvvv
...
for key, value in trunk.items():
    ...
    for val in value:
        if val == 'add':
            print(f'{trunk_template[2]} {val} {value[1]},{value[2]}\n')
        elif val == 'only':
            print(f'{trunk_template[2]} {value[1]},{value[2]}\n')
        elif val == 'del':
            print(f'{trunk_template[2]} {val} {value[1]}')
